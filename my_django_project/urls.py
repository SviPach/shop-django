...
urlpatterns = [
                  ...
                  path('category/<slug:slug_category>/<slug:slug_product>/', shop_views.product, name='product'),
                  path('category/<slug:category_slug>/', shop_views.category, name='category'),
                  path('about/', shop_views.about, name='about'),
                  path('privacy/', shop_views.privacy, name='privacy'),
                  path('terms/', shop_views.terms, name='terms'),
                  path('pricing/', shop_views.pricing, name='pricing'),
